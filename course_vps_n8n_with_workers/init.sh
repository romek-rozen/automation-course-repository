#!/bin/bash
# =============================================================================
# INIT SCRIPT - N8N WITH WORKERS (VPS)
# =============================================================================
...
echo ""
echo -e "${BLUE}=========================================="
echo "  INIT - n8n with Workers Stack"
echo -e "==========================================${NC}"
echo ""
...
safe_replace "POSTGRES_N8N_PASSWORD=WPISZ_HASLO_POSTGRES" "POSTGRES_N8N_PASSWORD=${POSTGRES_N8N_PASSWORD}" .env
